...
var STR = {
  tr: {
    ...
    tutSkip:'Atla', tutNext:'İleri', tutClose:'Kapat',
    // Sprint 80: interactive 8-step walkthrough
    tutStep_welcome_title:'VoltXAmpere\'e Hoş Geldiniz!',
    tutStep_welcome_body:'Bu kısa tur (≈2 dk) temel iş akışını gösterir: devre tasarla → simüle et → analiz et. Esc ile istediğin an çıkabilirsin. F1 ile geri çağırabilirsin.',
    tutStep_r_title:'1. adım — Direnç yerleştir',
    tutStep_r_body:'"1" tuşuna bas (veya sol panelden Direnç) ve canvas\'a tıkla. Direnç yerleşince otomatik devam edilecek.',
    tutStep_wire_title:'2. adım — Kablo çiz',
    tutStep_wire_body:'"W" tuşu ile kablo moduna gir. İki nokta arasını tıkla → kablo çizilir. İlk kablo çizildiğinde devam edilecek.',
    tutStep_v_title:'3. adım — Gerilim kaynağı ekle',
    tutStep_v_body:'"4" tuşu DC kaynak (5V varsayılan). "5" tuşu AC kaynak. Bir tane yerleştir.',
    tutStep_gnd_title:'4. adım — Toprak bağla',
    tutStep_gnd_body:'"8" tuşu Toprak. Referans düğüm olmadan simülasyon çalışmaz — bir tane ekle.',
    tutStep_sim_title:'5. adım — Simülasyonu başlat',
    tutStep_sim_body:'Space tuşuna bas (veya ▶ butonu). Elektronlar akmaya başlar; renk log-decade paletine göre I\'yi gösterir.',
    tutStep_probe_title:'6. adım — Multimetre probu',
    tutStep_probe_body:'Shift+P probu açar. Kırmızıyı bir pin/wire\'a, siyahı toprağa sürükle. Otomatik V/I/P okur; M ile mod, H ile hold döngüsü.',
    tutStep_done_title:'🎉 Tebrikler!',
    tutStep_done_body:'Temel workflow tamam. Daha fazla: "?" tuşu kısayol listesi, Bode/Nyquist için sekmelere bak, F1 turu yeniden başlatır.',
    ...
    tabPoleZero:'Kutup-Sıfır', tabContour2D:'2D Sweep', tabTransferFunc:'H(s)', tabCommands:'⌨ Komutlar', tabSParam:'📡 S-Param',
  ...
  en: {
    ...
    tutSkip:'Skip', tutNext:'Next', tutClose:'Close',
    // Sprint 80: interactive 8-step walkthrough
    tutStep_welcome_title:'Welcome to VoltXAmpere',
    tutStep_welcome_body:'This short tour (~2 min) covers the basic workflow: design → simulate → analyze. Press Esc to leave at any time; F1 brings it back.',
    tutStep_r_title:'Step 1 — Place a resistor',
    tutStep_r_body:'Press "1" (or pick Resistor from the left panel) and click the canvas. Placing one advances automatically.',
    tutStep_wire_title:'Step 2 — Draw a wire',
    tutStep_wire_body:'Press "W" for wire mode. Click two points to connect them. Your first wire advances the tour.',
    tutStep_v_title:'Step 3 — Add a voltage source',
    tutStep_v_body:'Press "4" for a DC source (5 V default) or "5" for AC. Drop one on the canvas.',
    tutStep_gnd_title:'Step 4 — Connect ground',
    tutStep_gnd_body:'Press "8" for Ground. Without a reference node the solver has nothing to stand on — drop one.',
    tutStep_sim_title:'Step 5 — Start the simulation',
    tutStep_sim_body:'Press Space (or the ▶ button). Electrons start flowing; color uses a log-decade palette keyed to current.',
    tutStep_probe_title:'Step 6 — Multimeter probe',
    tutStep_probe_body:'Shift+P toggles the probe. Drag the red tip to a pin or wire, black to ground. M cycles mode, H cycles hold.',
    tutStep_done_title:'🎉 You\'re ready',
    tutStep_done_body:'Basic workflow done. From here: "?" for shortcuts, check the Bode/Nyquist tabs, and F1 restarts this tour.',
    ...
    tabPoleZero:'Pole-Zero', tabContour2D:'2D Sweep', tabTransferFunc:'H(s)', tabCommands:'⌨ Commands', tabSParam:'📡 S-Param',
...
function updateTabLabels() {
  ...
  var map = {scope:'tabScope',bode:'tabBode',dcsweep:'tabDCSweep',paramsweep:'tabParam',
    ...
    commands:'tabCommands',sparam:'tabSParam'};
